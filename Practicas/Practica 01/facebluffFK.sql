...
CREATE TABLE `answers` (
  ...
  CONSTRAINT `supplanted` FOREIGN KEY (`supplanted`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `friendrequests` (
  ...
  CONSTRAINT `destinationUser` FOREIGN KEY (`destinationUser`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `originUser` FOREIGN KEY (`originUser`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `questions` (
  ...
  PRIMARY KEY (`id`)
  CONSTRAINT `questioner` FOREIGN KEY (`questioner`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2018-12-11 22:05:06
