class DAOUser{
	...
	confirmRequest(originUserId,destinationUserId,accept){
		this.pool.getConnection((err,connection)=>{
			...
			if (err) callback(new Error("Error al obtener la conexion"));
				...
				connection.query("UPDATE friendrequests SET status = ? WHERE destinationUser = ? and originUser = 2;",[status,destinationUserId,originUserId],
				(err)=>{
